...
const population = countries.map((country)=>+country.textContent.trim().replace(/,/g, ""));
const total = population.reduce((acumulator, currentValue)=>acumulator + currentValue, 0);
